...
fn spawn_waypoints(
    ...
    waypoints.inside = vec![
        ...
        Vec3::new(-15.0, 36.4119, -170.228),
        Vec3::new(15.0, 36.4119, -169.361),
        Vec3::new(-15.0, 36.4119, -129.468),
        Vec3::new(15.0, 36.4119, -129.468),
        Vec3::new(-15.0, 36.4119, -89.2278),
        Vec3::new(15.0, 36.4119, -89.2278),
        Vec3::new(-15.0, 36.4119, -50.0285),
        Vec3::new(15.0, 36.4119, -50.0285),
        Vec3::new(-15.0, 36.4119, -9.44168),
        Vec3::new(15.0, 36.4119, -9.44168),
        Vec3::new(-15.0, 36.4119, 29.0638),
        Vec3::new(15.0, 36.4119, 29.0638),
        Vec3::new(-15.0, 36.4119, 70.3444),
        Vec3::new(15.0, 36.4119, 70.3444),
